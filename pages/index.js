            ...
            <Row className={indexStyles.card} >
              <Col>
                <Card className="border-0 text-center">
                  ...
                  />
                  <Card.Body>
                    <Card.Text className={indexStyles.cardText2}>Current Orcasound hydrophone locations</Card.Text>
                  </Card.Body>
                </Card>
              </Col>
              <Col>
                <Card className="border-0">
                  <Card.Body>
                    <Card.Title className={indexStyles.cardTitle}> Hydrophone Location</Card.Title>
                    <br></br>
                ...
                <Card className="border-0">
                  <Card.Body>
                    ...
                    <div className={indexStyles.button}>
                      <br></br>
                      <Button className={indexStyles.cardButton}> LEARN</Button>{' '}
                      <Button className={indexStyles.cardButton}> GET INVOLVED!</Button>{' '}
                    </div>
                  </Card.Body>
                </Card>
              </Col>
